...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/oluwagbemigameduoye/git/pico_build/SSP2/build/_deps/pico_sdk-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/oluwagbemigameduoye/git/pico_build/SSP2/build/_deps/pico_sdk-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
...
if(init_submodules)
  execute_process(
    COMMAND "/usr/local/bin/git" --git-dir=.git submodule update  --init 
    WORKING_DIRECTORY "/Users/oluwagbemigameduoye/git/pico_build/SSP2/build/_deps/pico_sdk-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
